                    ...
                    <form @submit.prevent="submitForm" class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="col-span-2">
                                <label for="plan_affaire" class="block text-sm font-medium text-gray-700 mb-2">
                                    Plan d'affaires (PDF) <span class="text-red-500">*</span>
                                </label>
                                <div
                                    :class="[
                        ...
                        <div class="flex items-center justify-end mt-8">
                            <button type="submit"
                                ...
                                <span>{{ form.processing ? 'Création en cours...' : 'Créer le projet' }}</span>
                            </button>
                        </div>
                    </form>
                </div>
...
const isFormValid = computed(() => {
    ...
    const requiredFieldsFilled = form.titre && form.type && form.forme_juridique && form.plan_affaire;
...
function validateFile(file) {
    if (!file) {
        validationErrors.plan_affaire = 'Le fichier est requis';
        return false;
    }
...
function handleFileInput(event) {
    ...
    if (file) {
        if (validateFile(file)) {
            ...
            toast.error(validationErrors.plan_affaire);
        }
    }
}
